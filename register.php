    ...
    <div class="bg-white/95 backdrop-blur-lg p-10 rounded-3xl shadow-2xl w-full max-w-md border border-white/20">
        ...
        <?php if ($success): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-lg mb-6 text-center font-medium">
                <?= $success ?><br><a href="login.php" class="underline text-indigo-600">Prisijungti</a>
            </div>
        <?php endif; ?>
        <?php if ($error): ?>
        ...
        <?php endif; ?>
        <p class="text-center mt-8 text-gray-600">Jau turi paskyrą? <a href="login.php" class="text-indigo-600 font-bold hover:underline">Prisijungti</a></p>
    </div>
</body>
</html>